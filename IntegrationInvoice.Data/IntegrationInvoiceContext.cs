...
using IntegrationInvoice.Core.Domain.Identity;
...
{
    public class IntegrationInvoiceContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public IntegrationInvoiceContext(DbContextOptions options) : base(options)
        {
        }
